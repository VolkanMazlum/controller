...
class Script(PySimEngineScript):
    ...
    def initialize(self):
        ...
        self.hand = pybullet.getLinkState(self._skel_arm._body_id, self._skel_arm.HAND_LINK_ID,
                                      computeLinkVelocity=True)[0]
        self.pos_j= self._skel_arm.JointPos(arm_1dof.robot_arm_1dof.RobotArm1Dof.ELBOW_JOINT_ID)
        ...
        self._setDataPack("positions", {"hand": self.hand, "upperarm": self.upperarm, "elbow": self.pos_j }) # Bullet: “Body”, “Joint”, “Link”
    ...
    def runLoop(self, timestep):
        ...
        self._setDataPack("positions", { "hand": self.hand, "upperarm": self.upperarm, "elbow": self.pos_j } )
