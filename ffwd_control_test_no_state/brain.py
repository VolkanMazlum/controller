...
# nest.Connect(motor_prediction_p,mc.ffwd_p[j].pop, "one_to_one", {"weight": 0.1, "delay": res})
...
# nest.Connect(motor_prediction_n,mc.ffwd_n[j].pop, "one_to_one", {"weight": 0.1, "delay": res})
...
# nest.Connect(plan_to_inv_p, error_p, {'rule': 'all_to_all'}, syn_spec=syn_exc)
# nest.Connect(plan_to_inv_n, error_p, {'rule': 'all_to_all'}, syn_spec=syn_inh)
...
spikedetector_sn_pos = nest.Create("spike_detector", params={"withgid": True,"withtime": True, "to_file": True, "label": "Sensory feedback pos"})
spikedetector_sn_neg = nest.Create("spike_detector", params={"withgid": True,"withtime": True, "to_file": True, "label": "Sensory feedback neg"})
...
spikedetector_plan_to_inv_p = nest.Create("spike_detector", params={"withgid": True,"withtime": True, "to_file": True, "label": "Planner to inv pos"})
spikedetector_plan_to_inv_n = nest.Create("spike_detector", params={"withgid": True,"withtime": True, "to_file": True, "label": "Planner to inv neg"})
...
spikedetector_pred_pos = nest.Create("spike_detector", params={"withgid": True,"withtime": True, "to_file": True, "label": "Cereb motor pred pos"})
spikedetector_pred_neg = nest.Create("spike_detector", params={"withgid": True,"withtime": True, "to_file": True, "label": "Cereb motor pred neg"})

nest.Connect(sn_p[cereb_controlled_joint].pop, spikedetector_sn_pos)
nest.Connect(sn_n[cereb_controlled_joint].pop, spikedetector_sn_neg)
nest.Connect(feedback_p, spikedetector_fbk_pos)
nest.Connect(feedback_n, spikedetector_fbk_neg)
nest.Connect(error_p, spikedetector_io_input_pos)
nest.Connect(error_n, spikedetector_io_input_neg)
nest.Connect(plan_to_inv_p, spikedetector_plan_to_inv_p)
nest.Connect(plan_to_inv_n, spikedetector_plan_to_inv_n)
...
nest.Connect(motor_prediction_p, spikedetector_pred_pos)
nest.Connect(motor_prediction_n, spikedetector_pred_neg)
...
########################### PLOTTING ###########################
names = ["granule_cell","golgi_cell","dcn_cell_glut_large","purkinje_cell","basket_cell","stellate_cell","dcn_cell_GABA","mossy_fibers",'io_cell',"glomerulus","dcn_cell_Gly-I","Input inferior Olive pos","Input inferior Olive neg","Feedback pos","Feedback neg","Planner to inv pos","Planner to inv neg","Planner pos","Planner neg","Feedback cerebellum pos","Feedback cerebellum neg","Cereb pred pos","Cereb pred neg","State estimator Max pos","State estimator Max neg","Feedback smoothed pos","Feedback smoothed neg"]
cell_numerosity = {
    ...
    "Feedback pos": N,
    "Feedback neg": N,
    "Planner to inv pos": N,
    "Planner to inv neg": N,
    "Planner pos": N,
    "Planner neg": N,
