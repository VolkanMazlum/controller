...
class MotorCortex:
    ...
    def init_neurons(self, numNeurons, params):
        ...
        for i in range(self.numJoints):
            ...
            self.ffwd_p.append( PopView(tmp_pop_p, self.time_vect, to_file=True, label="mc_ffwd_p") )
            ...
            self.ffwd_n.append( PopView(tmp_pop_n,self.time_vect, to_file=True, label="mc_ffwd_n") )
            ...
            self.fbk_p.append( PopView(tmp_pop_p, self.time_vect, to_file=True, label="mc_fbk_p") )
            ...
            self.fbk_n.append( PopView(tmp_pop_n, self.time_vect, to_file=True, label="mc_fbk_n") )
            ...
            nest.SetStatus(tmp_pop_p, {"pos": True, "buffer_size": buf_sz, "simulation_steps": len(self.motorCommands)})
            self.out_p.append( PopView(tmp_pop_p, self.time_vect, to_file=True, label="mc_out_p") )

            # Negative population (joint i)
            tmp_pop_n = nest.Create("basic_neuron_nestml", n=numNeurons, params=par_out)
            nest.SetStatus(tmp_pop_n, {"pos": False, "buffer_size": buf_sz, "simulation_steps": len(self.motorCommands)})
            self.out_n.append( PopView(tmp_pop_n,self.time_vect, to_file=True, label="mc_out_n") )
