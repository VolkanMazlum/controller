...
sn_p, sn_n = populations.spine_pop_init(params, N, njt, time_vect)
#%% State estimator #######
...
prediction_p, prediction_n = populations.prediction_pop_init(pops_params, N)
''
...
fbk_smoothed_p,fbk_smoothed_n = populations.fbk_smoothed_pop_init(pops_params, N)
...
motor_commands_p, motor_commands_n = populations.motor_commands_pop_init(pops_params,n_forw)
# ''
...
''
feedback_p, feedback_n = populations.feedback_pop_init(pops_params, N)
...
error_p, error_n = populations.error_f_pop_init(pops_params, N)
...
plan_to_inv_p, plan_to_inv_n = populations.plan_to_inv_pop_init(pops_params, n)
...
motor_prediction_p, motor_prediction_n = populations.motor_pred_pop_init(pops_params,N)
''
...
feedback_inv_p, feedback_inv_n = populations.feedback_i(pops_params, N)
''
...
error_inv_p, error_inv_n = populations.error_i_pop_init(pops_params, N)
''
...
connections.connect_cereb_f(cerebellum_forw, 
                prediction_p, prediction_n,
                error_p, error_n, 
                motor_commands_p, motor_commands_n ,
                n_forw ,
                conn_params)

connections.connect_state(stEst, 
                          sn_p, sn_n, 
                          njt, 
                          fbk_smoothed_p, fbk_smoothed_n, 
                          prediction_p, prediction_n, 
                          conn_params, 
                          cereb_controlled_joint)

connections.mc_connections(planner, 
                            mc, 
                            conn_params, 
                            stEst, 
                            motor_prediction_p, motor_prediction_n, 
                            cereb_controlled_joint, 
                            njt)

connections.modulators_connect(mc,
                              planner, 
                              plan_to_inv_p, plan_to_inv_n, 
                              feedback_p, feedback_n, 
                              feedback_inv_p, feedback_inv_n, 
                              motor_commands_p, motor_commands_n, 
                              error_p, error_n, 
                              error_inv_p, error_inv_n, 
                              sn_p, sn_n, 
                              cereb_controlled_joint, 
                              conn_params)

connections.cereb_i_connect(cerebellum, 
                            motor_prediction_p, motor_prediction_n, 
                            error_inv_p, error_inv_n, 
                            plan_to_inv_p, plan_to_inv_n, 
                            conn_params)
